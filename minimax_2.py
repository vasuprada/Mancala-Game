                ...
                while picked_value != 0:
                        ...
                        if start_from <= len_one:
                                ...
                                #condition 2- ENDS IN EMPTY PIT ON SAME SIDE  
                                        ...
                                        flag2 = 0
                                        dummy[start_from] = 1
                                        dummy[len_one] += dummy[start_from]+ dummy[len_one+2]
                                        dummy[start_from] = 0
                                        dummy[len_one+2]= 0
